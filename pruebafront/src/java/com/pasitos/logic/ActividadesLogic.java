...
public class ActividadesLogic extends Logic 
{
    public List<ActividadesObj> getAllActividades()
    {
        ...
        String strSql = "SELECT * FROM sistemax.actividades;";
    ...
    public boolean insertActividades(String p_strNombre, String p_strApellidos, String p_strCorreo) 
    {
        ...
        DatabaseX database = getDatabase();
        hasFailed = database.executeNonQueryBool("insert into sistemax.actividades(id, nombre, apellidos, correo) values(0,'"+p_strNombre+"','"+p_strApellidos+"','"+p_strCorreo+"');");
